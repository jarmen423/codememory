...
CHANGE FROM PRIOR ITERATION ==> THIS ITERATION USES OPENSOURCE JINA MODEL INSTEAD OF OPEN AI TEXT 3 LARGE MODEL 
- JINA IS SPECIALIZED FOR CODE. LOWER DIMENSIONS ~750. 
Purpose:
...
def run_continuous_ingestion(wipe: bool = False):
    ...
    BATCH_SIZE = 50  # Increase with opensource model
